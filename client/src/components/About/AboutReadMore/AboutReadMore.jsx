    ...
    return (
      <section className="section-about" id="section-about">
        ...
        <aside className="aside-hobbies">
          {/* <h3>My Hobbies</h3> */}
          <p className="normal center">
            Cliquez sur les cercles pour voir mes centres d'intérêt
          </p>
          <div className="block-circles flex">{circlesHobbies}</div>
        </aside>

        <aside className="infos-hobbies">
          <Design
        ...
        <aside className="dots-slides">{dotsSlide}</aside>
      </section>
    );
  }
}
