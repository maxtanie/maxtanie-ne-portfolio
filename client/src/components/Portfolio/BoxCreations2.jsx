...
export default class Box extends Component {
	...
	render() {
		const { id, image, alt, filterItem, titleCreations, title, shortDescription } = this.props;
		return (
			<React.Fragment>
				<div className={`filter-item  ${filterItem}`}>
					<div className="box-design">
						<a className="link-none" href={`/portfolio/${titleCreations.toLowerCase()}`}>
							...
							<div className="block-content-txt">
								...
								<a className="link-read-more" href={`/portfolio/${titleCreations.toLowerCase()}`}>
									Read more...
								</a>
							</div>
						</a>
